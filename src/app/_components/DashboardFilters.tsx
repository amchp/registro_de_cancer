...
const ANTIOQUIA_MUNICIPALITIES = {
  'Valle de Aburrá': ['Medellín', 'Bello', 'Itagüí', 'Envigado', 'Sabaneta', 'La Estrella', 'Caldas', 'Copacabana', 'Girardota', 'Barbosa'].sort(),
  'Oriente': ['Rionegro', 'La Ceja', 'Marinilla', 'El Carmen de Viboral', 'Guatapé', 'San Carlos', 'Sonsón', 'El Santuario', 'Granada', 'Cocorná'].sort(),
  'Urabá': ['Apartadó', 'Turbo', 'Chigorodó', 'Carepa', 'Necoclí', 'San Pedro de Urabá', 'Arboletes', 'San Juan de Urabá', 'Mutatá'].sort(),
  'Suroeste': ['Andes', 'Ciudad Bolívar', 'Urrao', 'Jardín', 'Jericó', 'Támesis', 'Valparaíso', 'Caramanta', 'Tarso', 'Pueblorrico'].sort(),
  'Norte': ['Santa Rosa de Osos', 'Yarumal', 'San Pedro de los Milagros', 'Entrerríos', 'Don Matías', 'Belmira', 'San José de la Montaña', 'San Andrés de Cuerquia', 'Toledo', 'Campamento'].sort(),
  'Occidente': ['Santa Fe de Antioquia', 'Sopetrán', 'San Jerónimo', 'Olaya', 'Liborina', 'Sabanalarga', 'Buriticá', 'Peque', 'Cañasgordas', 'Frontino'].sort(),
  'Nordeste': ['Segovia', 'Remedios', 'Amalfi', 'Anorí', 'Cisneros', 'Santo Domingo', 'San Roque', 'Yolombó', 'Vegachí', 'Yalí'].sort(),
...
const DashboardFilters: React.FC<DashboardFiltersProps> = ({ onApplyFilters }) => {
  ...
  useEffect(() => {
    if (filters.subregion) {
      setAvailableMunicipalities(ANTIOQUIA_MUNICIPALITIES[filters.subregion as keyof typeof ANTIOQUIA_MUNICIPALITIES] || []);
      // Reset municipality when changing subregion
      if (filters.municipality && !ANTIOQUIA_MUNICIPALITIES[filters.subregion as keyof typeof ANTIOQUIA_MUNICIPALITIES]?.includes(filters.municipality)) {
  ...
  const handleApply = () => {
    // Format filters for API/URL consumption
  ...
  return (
    <div className="filter-container bg-white p-4 rounded-md shadow-sm mb-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2 items-end">
            <div className="flex-1">
              <Label htmlFor="yearRangeStart" className="text-xs">Desde</Label>
              <Input
                id="yearRangeStart"
            ...
            <div className="flex-1">
              <Label htmlFor="yearRangeEnd" className="text-xs">Hasta</Label>
              <Input
                id="yearRangeEnd"
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2 items-end">
            <div className="flex-1">
              <Label htmlFor="ageRangeStart" className="text-xs">Desde</Label>
              <Input
                id="ageRangeStart"
            ...
            <div className="flex-1">
              <Label htmlFor="ageRangeEnd" className="text-xs">Hasta</Label>
              <Input
                id="ageRangeEnd"
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2 items-end">
            <div className="flex-1">
              <Label htmlFor="cie10CodeStart" className="text-xs">Desde</Label>
              <Input
                id="cie10CodeStart"
            ...
            <div className="flex-1">
              <Label htmlFor="cie10CodeEnd" className="text-xs">Hasta</Label>
              <Input
                id="cie10CodeEnd"
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2 items-end">
            <div className="flex-1">
              <Label htmlFor="topographicCodeStart" className="text-xs">Desde</Label>
              <Input
            ...
            <div className="flex-1">
              <Label htmlFor="topographicCodeEnd" className="text-xs">Hasta</Label>
              <Input
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2 items-end">
            <div className="flex-1">
              <Label htmlFor="morphologicCodeStart" className="text-xs">Desde</Label>
              <Input
            ...
            <div className="flex-1">
              <Label htmlFor="morphologicCodeEnd" className="text-xs">Hasta</Label>
              <Input
